...
def open_login_page(root, open_next_page):
    # Clear previous widgets (in case of logout)
    ...
    # --- Username ---
    tk.Label(card, text="Username:", font=styles.FONT_LABEL,
             fg=styles.FG_COLOR, bg=styles.ENTRY_BG).pack()
    ...
    # --- Password ---
    tk.Label(card, text="Password:", font=styles.FONT_LABEL,
             fg=styles.FG_COLOR, bg=styles.ENTRY_BG).pack()
